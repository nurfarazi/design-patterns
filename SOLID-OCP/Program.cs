...
namespace SOLID_OCP
{
    internal class Program
    {
        ...
        private static void NewImplementation(Product[] products)
        {
            ...
            {
                System.Console.WriteLine($"{product.Name} is large");
            }
        }

        private static void OldImplementation(Product[] products)
        {
